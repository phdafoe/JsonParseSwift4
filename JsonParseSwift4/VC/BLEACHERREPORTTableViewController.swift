//
//  BLEACHERREPORTTableViewController.swift
//  iCoNews
//
...
class BLEACHERREPORTTableViewController: UITableViewController {
    //MARK: - Variables locales
    var arrayModelBLEACHER : [ModelGeneralData] = []
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return arrayModelBLEACHER.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = arrayModelBLEACHER[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let objInd = arrayModelBLEACHER[selectInd!]
    ...
    //MARK: - UTILS
    func llamadaBLEACHER(){
        
        let datosModelBLEACHER = ParserGeneral()
        let idFuente = CONSTANTES.LLAMADAS.BASE_BLACHER_NEWS
        
        APESuperHUD.showOrUpdateHUD(loadingIndicator: .standard, message: "Cargando", presentingView: self.view)
        
        firstly{
            return when(resolved: datosModelBLEACHER.getDatosFromWeb(idFuente))
            }.then{_ in
                self.arrayModelBLEACHER = datosModelBLEACHER.setParseFromWeb()
            }.then{_ in
