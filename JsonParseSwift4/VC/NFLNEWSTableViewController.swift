//
//  NFLNEWSTableViewController.swift
//  iCoNews
//
...
class NFLNEWSTableViewController: UITableViewController {
    
    //MARK: - Variables locales
    var arrayModelNFL : [ModelGeneralData] = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let model = arrayModelNFL[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let objInd = arrayModelNFL[selectInd!]
    ...
    func llamadaNFLNEWS(){
        ...
        let datosModelNFL = ParserGeneral()
        let idFuente = CONSTANTES.LLAMADAS.BASE_NFL_NEWS
        
        APESuperHUD.showOrUpdateHUD(loadingIndicator: .standard, message: "Cargando", presentingView: self.view)
        
        firstly{
            return when(resolved: datosModelNFL.getDatosFromWeb(idFuente))
            }.then{_ in
                self.arrayModelNFL = datosModelNFL.setParseFromWeb()
            }.then{_ in
